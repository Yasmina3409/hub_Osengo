...
$version = $db->create('versions',   array('projet_id', 'versionUrl', 'version_name'), array($test, $_POST["versionUrl"], $_POST["version_name"]));



header('location:./index.php');
// }
// if ($_POST["titre"] == '' || $_POST["type"] = "" || $_POST["imageUrl"] = '' || $_POST["description"] = '') {
//     header('location: ./create.php'); // sert à faire une redirection 
// } else {
